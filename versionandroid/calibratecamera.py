...
class TouchApp(App):
    ...
    def capture(self, btn):
        ...
        aimg = cv2.imread(mydir+'5.png')
        cv2.imwrite(mydir+'5.jpg', aimg, [int(cv2.IMWRITE_JPEG_QUALITY), 100])
        self.img.source = mydir+'5.jpg'
        self.img.reload()
...
#           textfield.text = "" # Uncomment if you want to make the field empty.
    ...
    def build(self):
        ...
        Parent = BoxLayout(orientation='vertical', minimum_height = '8000dp')
        ...
        Parent.ids['toplbl'] = toplabel
        Parent.add_widget(toplabel)
